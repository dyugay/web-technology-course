...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'qa_question', (
            ...
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.DO_NOTHING)),
        ))
        db.send_create_signal(u'qa', ['Question'])

        # Adding M2M table for field likes on 'Question'
        m2m_table_name = db.shorten_name(u'qa_question_likes')
        ...
        # Adding M2M table for field author on 'Answer'
        m2m_table_name = db.shorten_name(u'qa_answer_author')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'qa_question_likes'))

        # Deleting model 'Answer'
        db.delete_table(u'qa_answer')

        # Removing M2M table for field author on 'Answer'
        db.delete_table(db.shorten_name(u'qa_answer_author'))
    ...
    models = {
        ...
        u'qa.answer': {
            ...
            'author': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'qa.question': {
            ...
            'added_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'on_delete': 'models.DO_NOTHING'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'likes': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'likes_set'", 'symmetrical': 'False', 'to': u"orm['auth.User']"}),
